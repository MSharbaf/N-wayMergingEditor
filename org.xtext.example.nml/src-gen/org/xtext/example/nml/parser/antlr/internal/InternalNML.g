...
entryRuleDomainCP returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDomainCPRule()); }
	iv_ruleDomainCP=ruleDomainCP
	{ $current=$iv_ruleDomainCP.current; }
	EOF;

// Rule DomainCP
ruleDomainCP returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleOctopusCP returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getOctopusCPRule()); }
	iv_ruleOctopusCP=ruleOctopusCP
	{ $current=$iv_ruleOctopusCP.current; }
	EOF;

// Rule OctopusCP
ruleOctopusCP returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleOursCP returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getOursCPRule()); }
	iv_ruleOursCP=ruleOursCP
	{ $current=$iv_ruleOursCP.current; }
	EOF;

// Rule OursCP
ruleOursCP returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulemodelOrderCS returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getModelOrderCSRule()); }
	iv_rulemodelOrderCS=rulemodelOrderCS
	{ $current=$iv_rulemodelOrderCS.current; }
	EOF;

// Rule modelOrderCS
rulemodelOrderCS returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleConditionCS returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConditionCSRule()); }
	iv_ruleConditionCS=ruleConditionCS
	{ $current=$iv_ruleConditionCS.current; }
	EOF;

// Rule ConditionCS
ruleConditionCS returns [EObject current=null]
@init {
	enterRule();
}
@after {
