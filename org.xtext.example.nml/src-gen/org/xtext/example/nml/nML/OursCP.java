...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Ours CP</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.nml.nML.OursCP#getOwnedModels <em>Owned Models</em>}</li>
 *   <li>{@link org.xtext.example.nml.nML.OursCP#getOwnedOrders <em>Owned Orders</em>}</li>
 *   <li>{@link org.xtext.example.nml.nML.OursCP#getOwnedStatement <em>Owned Statement</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.nml.nML.NMLPackage#getOursCP()
 * @model
 * @generated
 */
public interface OursCP extends EObject
{
  /**
   ...
   * @see org.xtext.example.nml.nML.NMLPackage#getOursCP_OwnedModels()
   ...
   * The list contents are of type {@link org.xtext.example.nml.nML.modelOrderCS}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.nml.nML.NMLPackage#getOursCP_OwnedOrders()
   * @model containment="true"
   * @generated
   */
  EList<modelOrderCS> getOwnedOrders();
   ...
   * @see org.xtext.example.nml.nML.NMLPackage#getOursCP_OwnedStatement()
   * @model containment="true"
   * @generated
   */
