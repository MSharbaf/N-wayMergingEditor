 ...
 */
package org.xtext.example.nml.ide.contentassist.antlr;
...
import org.xtext.example.nml.ide.contentassist.antlr.internal.InternalNMLParser;
import org.xtext.example.nml.services.NMLGrammarAccess;

public class NMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(NMLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, NMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTopLevelCPAccess().getGroup_6(), "rule__TopLevelCP__Group_6__0");
			builder.put(grammarAccess.getTopLevelCPAccess().getGroup_7(), "rule__TopLevelCP__Group_7__0");
			builder.put(grammarAccess.getTopLevelCPAccess().getGroup_8(), "rule__TopLevelCP__Group_8__0");
			builder.put(grammarAccess.getDomainCPAccess().getGroup(), "rule__DomainCP__Group__0");
			builder.put(grammarAccess.getDomainCPAccess().getGroup_1(), "rule__DomainCP__Group_1__0");
			builder.put(grammarAccess.getOctopusCPAccess().getGroup(), "rule__OctopusCP__Group__0");
			builder.put(grammarAccess.getOctopusCPAccess().getGroup_4(), "rule__OctopusCP__Group_4__0");
			builder.put(grammarAccess.getOctopusCPAccess().getGroup_5(), "rule__OctopusCP__Group_5__0");
			builder.put(grammarAccess.getOctopusCPAccess().getGroup_8(), "rule__OctopusCP__Group_8__0");
			builder.put(grammarAccess.getOctopusCPAccess().getGroup_8_2(), "rule__OctopusCP__Group_8_2__0");
			builder.put(grammarAccess.getOursCPAccess().getGroup(), "rule__OursCP__Group__0");
			builder.put(grammarAccess.getOursCPAccess().getGroup_4(), "rule__OursCP__Group_4__0");
			builder.put(grammarAccess.getOursCPAccess().getGroup_5(), "rule__OursCP__Group_5__0");
			builder.put(grammarAccess.getOursCPAccess().getGroup_5_2(), "rule__OursCP__Group_5_2__0");
			builder.put(grammarAccess.getOursCPAccess().getGroup_6(), "rule__OursCP__Group_6__0");
			...
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedDomainsAssignment_3(), "rule__TopLevelCP__OwnedDomainsAssignment_3");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedPreAssignment_4_3(), "rule__TopLevelCP__OwnedPreAssignment_4_3");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedOctopusAssignment_5_2(), "rule__TopLevelCP__OwnedOctopusAssignment_5_2");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedOursAssignment_6_2(), "rule__TopLevelCP__OwnedOursAssignment_6_2");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedTransformationAssignment_7_2(), "rule__TopLevelCP__OwnedTransformationAssignment_7_2");
			builder.put(grammarAccess.getTopLevelCPAccess().getOwnedPreAssignment_8_3(), "rule__TopLevelCP__OwnedPreAssignment_8_3");
			builder.put(grammarAccess.getDomainCPAccess().getNameAssignment_1_0(), "rule__DomainCP__NameAssignment_1_0");
			builder.put(grammarAccess.getDomainCPAccess().getNsURIAssignment_2(), "rule__DomainCP__NsURIAssignment_2");
			builder.put(grammarAccess.getOctopusCPAccess().getOwnedModelsAssignment_1(), "rule__OctopusCP__OwnedModelsAssignment_1");
			builder.put(grammarAccess.getOctopusCPAccess().getOwnedModelsAssignment_3(), "rule__OctopusCP__OwnedModelsAssignment_3");
			builder.put(grammarAccess.getOctopusCPAccess().getOwnedModelsAssignment_4_1(), "rule__OctopusCP__OwnedModelsAssignment_4_1");
			builder.put(grammarAccess.getOctopusCPAccess().getOwnedModelsAssignment_5_1(), "rule__OctopusCP__OwnedModelsAssignment_5_1");
			builder.put(grammarAccess.getOctopusCPAccess().getOwnedModelsAssignment_7(), "rule__OctopusCP__OwnedModelsAssignment_7");
			builder.put(grammarAccess.getOctopusCPAccess().getOwnedConditionsAssignment_10(), "rule__OctopusCP__OwnedConditionsAssignment_10");
			builder.put(grammarAccess.getOursCPAccess().getOwnedModelsAssignment_1(), "rule__OursCP__OwnedModelsAssignment_1");
			builder.put(grammarAccess.getOursCPAccess().getOwnedModelsAssignment_3(), "rule__OursCP__OwnedModelsAssignment_3");
			builder.put(grammarAccess.getOursCPAccess().getOwnedModelsAssignment_4_1(), "rule__OursCP__OwnedModelsAssignment_4_1");
			builder.put(grammarAccess.getOursCPAccess().getOwnedModelsAssignment_5_1(), "rule__OursCP__OwnedModelsAssignment_5_1");
			builder.put(grammarAccess.getOursCPAccess().getOwnedOrdersAssignment_6_1(), "rule__OursCP__OwnedOrdersAssignment_6_1");
			...
			builder.put(grammarAccess.getConditionCSAccess().getOwnedElementAssignment_0(), "rule__ConditionCS__OwnedElementAssignment_0");
			builder.put(grammarAccess.getConditionCSAccess().getOwnedElementAssignment_2(), "rule__ConditionCS__OwnedElementAssignment_2");
	...
	@Override
	protected InternalNMLParser createParser() {
		InternalNMLParser result = new InternalNMLParser(null);
